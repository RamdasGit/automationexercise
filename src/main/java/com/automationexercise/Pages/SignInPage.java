...
public class SignInPage extends BaseClass{
	...
	public SignInPage() {
		...
		try {
			FileInputStream configFile = new FileInputStream("C:\\Users\\s\\Desktop\\Selenium\\ExcelR\\AutomationExcercise\\src\\main\\java\\com\\automationexercise\\config\\config.properties");
	...
	public void logIn(String username, String password) {
		...
		Assert.assertEquals(loggedInAsUname.getText().trim(), "Logged in as " + "Ramdas100");
	...
	public void logOutUser() {
		...
		email.sendKeys("ramdas001@gmail.com");

		pass.sendKeys("ramdas001");

		login.click();

		Assert.assertEquals(loggedInAsUname.getText().trim(), "Logged in as " + "ramdas001");
