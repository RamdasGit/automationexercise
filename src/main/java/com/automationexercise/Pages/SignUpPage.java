...
public class SignUpPage extends BaseClass {
	...
	public void signUp() {
		...
		String Name = "rekawade31";
		name.sendKeys(Name);
		
		Email.sendKeys("rekawade31@gmail.com");
	...
	public void regWthExistingUser() {
		...
		Assert.assertEquals(actualResult, "New User Signup!");
		System.out.println(" 'New User Signup!' is visible");
		String Name = "rekawade1";
		name.sendKeys(Name);
		Email.sendKeys("rekawade1@gmail.com");
		Signup.click();
